...
-- | ```
traversed ∷ ∀ t a b. Traversable t ⇒ Traversal (t a) (t b) a b
...
-- | unit
-- | ```
sequenceOf ∷ ∀ f s t a. Optic (Star f) s t (f a) a → s → f t
...
cloneTraversal ∷ ∀ s t a b. ATraversal s t a b → Traversal s t a b
cloneTraversal l = wander (runBazaar (l (Bazaar identity)))

both ∷ ∀ r a b. Bitraversable r ⇒ Traversal (r a a) (r b b) a b
