...
curried ∷ ∀ a b c d e f. Iso (Tuple a b → c) (Tuple d e → f) (a → b → c) (d → e → f)
curried = iso curry uncurry

uncurried ∷ ∀ a b c d e f. Iso (a → b → c) (d → e → f) (Tuple a b → c) (Tuple d e → f)
uncurried = iso uncurry curry

flipped ∷ ∀ a b c d e f. Iso (a → b → c) (d → e → f) (b → a → c) (e → d → f)
...
-- |```
coerced ∷ ∀ s t a b. Coercible s a ⇒ Coercible t b ⇒ Iso s t a b
