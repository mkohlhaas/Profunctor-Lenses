...
findOf ∷ ∀ s t a b. Fold (Endo (→) (Maybe a)) s t a b → (a → Boolean) → s → Maybe a
...
replicated ∷ ∀ a b t r. Monoid r ⇒ Int → Fold r a b a t
...
folded ∷ ∀ g a b t r. Monoid r ⇒ Foldable g ⇒ Fold r (g a) b a t
